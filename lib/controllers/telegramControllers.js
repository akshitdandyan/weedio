...
telegram_1.default.on("message", function (message) {
    ...
    if (message.text === "/start") {
        telegram_1.default.setMyCommands([
            ...
            {
                command: "/" + constants_1.VIDEO_FEATURES.reduceSize,
                description: "Reduce video file size with ulta compression",
            },
            {
                command: "/" + constants_1.VIDEO_FEATURES.trimVideo,
                description: "Trim video within a time range",
            },
            {
                command: "/" + constants_1.VIDEO_FEATURES.removeAudio,
                description: "Remove audio from video",
            },
            {
                command: "/" + constants_1.VIDEO_FEATURES.extractAudio,
                description: "Get music from video",
            },
            {
                command: "/" + constants_1.VIDEO_FEATURES.modifySpeed,
    ...
    else if ((0, helpers_1.isFeature)(message.text)) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [3 /*break*/, 11];
                        case 2:
                            if (!(client_1.feature === "video-trim" && client_1.options.length === 2)) return [3 /*break*/, 4];
