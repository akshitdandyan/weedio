...
function getSS() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            try {
                process_1 = (0, fluent_ffmpeg_1.default)("./video.mp4").takeScreenshots({
                    count: 1,
...
function addSubtitles() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            try {
                process_2 = (0, fluent_ffmpeg_1.default)("./video.mp4")
                ...
                case 0:
                    ...
                    return [4 /*yield*/, new Promise(function (resolve, reject) {
                            (0, fluent_ffmpeg_1.default)(payload.fileLocation)
                                .setStartTime((0, helpers_1.formatSecondsIntoHHMMSS)(payload.startTime))
